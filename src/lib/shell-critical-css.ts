...
html[data-theme="dark"],html[data-theme="dark"] body{background:var(--ink);color:var(--paper)}
...
html[data-splash="seen"]:not([data-shell="fault"]) #bc-splash{display:none}
html[data-shell="fault"] #bc-splash,html[data-shell="fault"] #bc-splash.bc-splash--fade{display:flex!important;opacity:1!important;transition:none}
...
html[data-shell="fault"] #bc-splash .bc-splash__recover{display:block}
